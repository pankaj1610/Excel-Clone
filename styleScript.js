...
let allFontStyleOptions = document.querySelectorAll(".bold-italics-underline span");
let menuBarOptions = document.querySelectorAll(".menu-bar-section div");

let fileOptions = menuBarOptions[0];

let body = document.querySelector("body");
let boldOption = allFontStyleOptions[0];
let italicOption = allFontStyleOptions[1];
let underLineOption = allFontStyleOptions[2];
